...
const AddDoctors = () => {
  ...
  return (
    <form onSubmit={onsubmitHandler}  className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border rounded w-full max-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <button  type="submit"  className="bg-blue-400 px-10 py-3 text-white rounded-full">Add Doctor</button>
      </div>
    </form>
  );
};
